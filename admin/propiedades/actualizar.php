<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if(!$estacionamiento) $errores[] = 'El Número de lugares de Estacionamiento es obligatorio';
        ...
        if(empty($errores)) {
            ...
            if($resultado) header('Location: /admin?resultado=2'); // Redireccionar al usuario.
        }
    }
