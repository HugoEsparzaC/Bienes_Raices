    ...
    <main class="contenedor seccion">
        <section class="seccion contenedor">
            ...
            <div class="contenedor-anuncios">
                ...
                <div class="anuncio">
                    <picture>
                        <source srcset="build/img/full/anuncio4.avif" type="image/avif">
                        <source srcset="build/img/full/anuncio4.webp" type="image/webp">
                        <img loading="lazy" src="build/img/full/anuncio4.jpg" alt="anuncio">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa de Lujo en el Lago</h3>
                        <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
                ...
                <div class="anuncio">
                    <picture>
                        <source srcset="build/img/full/anuncio5.avif" type="image/avif">
                        <source srcset="build/img/full/anuncio5.webp" type="image/webp">
                        <img loading="lazy" src="build/img/full/anuncio5.jpg" alt="anuncio">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa Terminados de Lujo</h3>
                        <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
                ...
                <div class="anuncio">
                    <picture>
                        <source srcset="build/img/full/anuncio6.avif" type="image/avif">
                        <source srcset="build/img/full/anuncio6.webp" type="image/webp">
                        <img loading="lazy" src="build/img/full/anuncio6.jpg" alt="anuncio">
                    </picture>
                    <div class="contenido-anuncio">
                        <h3>Casa con Alberca</h3>
                        <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
